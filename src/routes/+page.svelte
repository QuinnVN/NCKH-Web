...
<svelte:head>
	...
	<meta
		...
		content="Định hướng nghề nghiệp bằng AI × VR cho một tương lai mang dấu ấn của bạn."
	/>
</svelte:head>
...
<main>
	<section class="relative overflow-hidden border-b border-line" aria-labelledby="hero-heading">
		...
		>
			<span><b>◎</b> đánh giá<br />bằng AI</span><span><b>⌁</b> mô phỏng VR<br />sống động</span
			><span><b>◈</b> góc nhìn nghề nghiệp<br />cá nhân hóa</span><span
				><b>◇</b> quyết định sẵn sàng<br />cho tương lai</span
			>
		</div>
	</section>
