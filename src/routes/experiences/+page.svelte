	...
	<div class="library-shell">
			...
			<button class="recommended-card" type="button" onclick={() => openDetails(recommended)}>
				...
				<div class="recommended-content">
					<div class="card-topline">
						<span class="status status-recommended">{statusLabel(recommended.status)} <i></i></span
		...
		<div class="results-row">
			...
			{#if query || filter !== 'Tất cả'}
				<button class="text-button" type="button" onclick={clearFilters}> Xóa bộ lọc ↗ </button>
			{/if}
		</div>
				...
				{#each supportingExperiences as experience (experience.slug)}
					<button class="experience-card" type="button" onclick={() => openDetails(experience)}>
						<div class="experience-image">
							...
							<span class:locked={experience.status === 'locked'} class="status overlay-status"
								>{statusLabel(experience.status)}</span
							>
						</div>
						<div class="experience-body">
							<div class="card-topline">
								<span class="category-label">{experience.category}</span><span
							...
							<span class="card-action">Xem chi tiết <span aria-hidden="true">→</span></span>
						</div>
					</button>
				{/each}
			</section>
		{:else}
			<section class="empty-results">
				...
				<button class="button button-outline" type="button" onclick={clearFilters}>
		...
		<footer class="library-footer">
			<a href="/evaluation">← Quay lại kết quả</a><span
		...
		>
			{#if selected}
				<div class="dialog-head">
					...
					<Dialog.Close class="dialog-close" aria-label="Đóng chi tiết">×</Dialog.Close>
				</div>
				...
				<div class="dialog-actions">
					<Dialog.Close class="button button-outline">Quay lại kết quả</Dialog.Close><a
						class="button button-lime"
						href="/evaluation">Xem hồ sơ <span aria-hidden="true">↗</span></a
					>
				</div>
			{/if}
		</Dialog.Content>
